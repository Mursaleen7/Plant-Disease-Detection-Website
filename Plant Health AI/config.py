...
def create_plant_models():
    ...
    models = {
        'potato': {
            ...
            'model_weight_path': os.path.join(current_dir, 'weights', 'potato_model.weights.h5')
        },
        'apple': {
            'class_names': ['Apple___Apple_scab', 'Apple___Black_rot', 'Apple___Cedar_apple_rust', 'Apple___healthy'],
            'model_weight_path': os.path.join(current_dir, 'weights', 'apple_model.weights.h5')
        },
        'corn': {
            ...
            'model_weight_path': os.path.join(current_dir, 'weights', 'corn_model.weights.h5')
        },
        'grape': {
            ...
            'model_weight_path': os.path.join(current_dir, 'weights', 'grape_model.weights.h5')
        }
    }
